...
- **Component Playground**: Interactive showcase at `/playground` with 4 organized tabs:
  ...
  - **Components Tab**: Alphabetically organized component demos including:
    ...
    - Input: Standard text input component with email, password, and disabled state examples (no search icon by default)
    - Input OTP: One-time password input with individual character slots and separator
